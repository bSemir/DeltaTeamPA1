...
import 'package:delta_team/features/lectures/recent_lectures.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

import '../login/amplify_auth.dart';
import '../login/login_mobile/loginmobile_body.dart';
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const RecentLectures()),
                        ).then((value) {
                          setState(() {
